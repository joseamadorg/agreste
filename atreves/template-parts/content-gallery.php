	        ...
	        if (!empty($gallery_images)) : ?>
	            <div class="postbox-gallery mb-30">
	                ...
	                foreach( $gallery_images as $key => $image ) :   
	                	$image_url = wp_get_attachment_image_src($key, 'atreves-main-blog', true);
	                	?>
	                    <img src="<?php echo esc_url($image_url[0]); ?>" alt="<?php print esc_attr__('image','atreves'); ?>" />
	                <?php 
	                endforeach; ?>
	            </div>
	        <?php 
